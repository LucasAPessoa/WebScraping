...
@promotion_router.put("/{promotion_id}", response_model=PromotionRead, status_code=status.HTTP_200_OK)
...
@promotion_router.get("/{promotion_id}", response_model=PromotionRead, status_code=status.HTTP_200_OK)
...
@promotion_router.get("/", response_model=PromotionReadList, status_code=status.HTTP_200_OK)
